<%@ page language="java" import="java.util.*,com.po.User,com.po.Hotel" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
		...
		<div class="container setting" style="min-height: 46px;">
			...
			<div class="i-upload clearfix">
				<div class="nav rounded  clearfix">
					...
					<a href="javascript:;" class="nav-item actived">音乐馆</a>
							...
							if(list==null||list.size()==0){
								...
								while(i.hasNext()){
									...
									if(hotel.getHotelId()==null){
										...
										<div class="item">
										<a href="createNewHotel.jsp" class="cover-wrapper" id="newHotel">
											<img src="img/icon-add-1.jpg" alt="添加新的hotel" class="cover rounded">
										</a>
										<a href="createNewHotel.jsp" class="name">创建hotel</a>
										<div class="op-bar" style="display:none">
											<span class="time"></span>
		
											<a rel="nofollow" class="btn-action-like unfav delete" data-id="" data-type="vol" data-cback="vol_unlike_cback" data-confirm="确定删除该hotel吗？">
									...
									<div class="item">
										...
										<div class="op-bar">
											...
											<a rel="nofollow" class="btn-action-like unfav delete" data-id="<%=hotel.getHotelId() %>" data-type="vol" data-cback="vol_unlike_cback" data-confirm="确定删除该hotel吗？">
			...
			<div class="i-like clearfix">
				...
				<!-- uc-ct -->
				<div class="uc-ct" style="display:none">
		...
		<script type="text/javascript">
			$(function() {
				...
				$("a.delete").click(function(){
					...
					$.confirm({
						title : ' ',
						content : '确定删除添加的该hotel吗？',
						confirm : function() {
							location.assign("deleteMyHotel.action?hotelId="+hotelId);
						},
						cancel : function() {

					...
					<%
						if(list==null||list.size()==0){
							...
							<div class="item">	
								...
								<div class="item-ct">
									<a href="http://www.luoo.net/essay/779" class="title"><%=article.getTitile() %></a>
									<p class="subscribe">每个人都有属于自己的表达方式，我的渠道是：歌曲。所以我的歌是内心所想。</p>
								</div>
							</div>
							<div class="clearfix">
								<span class="time"><%=article.getArticleDate() %></span>
			...
			$(function() {
				...
				$(".delete").click(function(){
					...
					$.confirm({
						...
						content : '确定删除添加的该文章吗？',
						confirm : function() {
							location.assign("deleteMyArticle.action?articleId="+articleId);
						},
						cancel : function() {

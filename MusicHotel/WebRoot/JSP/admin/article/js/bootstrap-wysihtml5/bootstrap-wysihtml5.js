        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "</div>" +
                "<div class='modal-body'>" +
                  "<a class='btn btn-file'><i class='fa fa-folder'></i>选择图片<input type='file' class='bootstrap-wysihtml5-insert-image-url form-control large'/>" +
                "&nbsp;&nbsp;<span class='insert-image-url'></span></a>" +
                "</div>" +
                "<div class='modal-footer'>" +

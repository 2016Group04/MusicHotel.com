...
@Controller
public class HotelController implements ServletConfigAware, ServletContextAware {
	...
	public String addMyHotel(ModelMap model, HttpServletRequest request,
			Hotel hotel,@RequestParam("hotelCover") MultipartFile file) {

		System.out.println("in addMyHotel");
		System.out.println(hotel.getTitle());
		String target = "";

		model.addAttribute("hotelDesc", hotel.getHotelDesc());

		Hotel hotel1 = hotelService.upload(request, hotel, file);
